...
<div class="max-w-screen-xl mx-auto px-4 py-6">
    ...
    <!-- Directorio -->
    <h3 class="text-2xl font-bold mt-8 mb-4 text-center">Directorio</h3>
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <!-- Tarjeta de miembro del directorio -->
        <div class="bg-white shadow-lg rounded-lg p-4">
            <img src="path/to/directive1.jpg" alt="" class="w-32 h-32 rounded-full mx-auto">
            <h4 class="text-xl mt-4 font-semibold">Responsable del CIDASQROO</h4>
            <p class="text-md">Titular: Mtra. Aurora Xolalpa Aroche</p>
        </div>
        <div class="bg-white shadow-lg rounded-lg p-4">
            <img src="path/to/directive2.jpg" alt="" class="w-32 h-32 rounded-full mx-auto">
        ...
        <div class="bg-white shadow-lg rounded-lg p-4">
            <img src="path/to/directive3.jpg" alt="" class="w-32 h-32 rounded-full mx-auto">
            <h4 class="text-xl mt-4 font-semibold">Investigador po México</h4>
            <p class="text-md">Titular: Dr. Fausto Rivero</p>
        </div>
        <div class="bg-white shadow-lg rounded-lg p-4">
            <img src="path/to/directive4.jpg" alt="" class="w-32 h-32 rounded-full mx-auto">
