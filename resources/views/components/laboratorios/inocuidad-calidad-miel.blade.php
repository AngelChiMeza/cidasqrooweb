<div>
    <h1 class="text-4xl font-bold mb-4">Laboratorio de inocuidad y calidad de miel y sus derivados</h1>
    <img src="https://via.placeholder.com/1000x500" alt="Inocuidad y calidad de miel" class="w-full h-auto mb-4">
    <p class="mb-4"><strong>Responsable:</strong> <a href="#" class="text-red-900 ">Ing. Cristian Suarez</a></p>
