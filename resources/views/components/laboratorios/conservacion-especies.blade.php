...
<div>
    <h1 class="text-4xl font-bold  bg-red-900 text-white inline-block px-8 my-8 rounded-r-3xl">Conservación de especies botánicas y entomológicas</h1>
