            ...
            <div id="default-carousel" class="relative w-full" data-carousel="slide">
                ...
                <div class="relative h-56 overflow-hidden md:h-[600px]">
                    ...
                    <div class="hidden duration-700 ease-in-out" data-carousel-item>
                        ...
                        <div class="absolute bottom-4 left-4 text-left text-gray-600 bg-slate-200 w-1/3">
                            <h2 class="text-3xl font-bold">Construyendo puentes hacia la búsqueda de soluciones a los problemas socioecológicos en la Península de Yucatán</h2>
                            <h3 class="text-md">El Centro de Innovación para el Desarrollo Apícola Sustentable en Quintana Roo mantiene proyectos de vinculación con otras instituciones, tal es el caso del proyecto PRONAII “Construyendo puentes hacia la</h3>
                            <p class="text-lg bg-red-500 text-white inline-block px-5 my-5 rounded-r-lg"><span class="font-bold">Fecha del evento:</span>  29 de mayo de 2024</p>
                        </div>
                    </div>
                    <!-- Item 2 -->
                    <div class="hidden duration-700 ease-in-out" data-carousel-item>
